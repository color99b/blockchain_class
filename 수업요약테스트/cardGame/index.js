...
function selectNum(cardNum) {
  ...
  const tempElem = document.getElementsByClass("card" + cardNum)[n];
  ...
  compare(firstCardIdx, secondCardIdx);

  cardSelect(firstCardIdx, secondCardIdx);
